...
def main(args) -> None:
    ...
    if args.enable_vlog_logging and hasattr(wrapper._framework, "set_vlog_logging"):
        wrapper._framework.set_vlog_logging(args.vlog_log_dir)
...
def build_argparser():
    ...
    parser.add_argument("--framework_name", type=str, default=None, help="Compatibility argument for VLOG eval scripts.")
    parser.add_argument("--vlog_checkpoint", type=str, default=None, help="Compatibility argument for two-part VLOG eval scripts.")
    parser.add_argument("--enable_vlog_logging", action="store_true")
    parser.add_argument("--vlog_log_dir", type=str, default=None)
    return parser
